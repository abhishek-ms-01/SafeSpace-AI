...
export function ThreatDetectionPanel({ result, loading = false }: ThreatDetectionPanelProps) {
  if (loading) {
    return (
      <div className="glass-card p-6 border border-white/5 dark:border-slate-800/50 backdrop-blur-md relative overflow-hidden bg-slate-950/20 shadow-xl rounded-2xl">
