...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=220&section=header&text=SafeSpace%20AI&fontSize=90&fontColor=ffffff&fontAlignY=38&desc=Anonymous%20Sanctuary%20%26%20Incident%20Analyzer&descAlignY=60&descSize=22&animation=fadeIn"/>

<br/>

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=1000&color=6366F1&center=true&vCenter=true&width=750&lines=🛡️+Evaluate+Harassment+with+Privacy-Focused+AI;🤖+Empathetic+Trauma-Informed+Support+Companion;📋+Standardized+Incident+PDF+Report+Generation;⚖️+Static+Legal+Rights+Information+Lookup" alt="Typing SVG" />

<br/>

<p>
  <img src="https://img.shields.io/badge/Status-🟢_Live-10B981?style=for-the-badge" />
  <img src="https://img.shields.io/badge/AI-Groq_SDK-4F46E5?style=for-the-badge&logo=google-cloud&logoColor=white" />
  <img src="https://img.shields.io/badge/Stack-React_19_%7C_TypeScript-007acc?style=for-the-badge&logo=react&logoColor=white" />
...
<p>
  <a href="https://safespace-ai-five.vercel.app" target="_blank">
    <img src="https://img.shields.io/badge/🌐_Live_Demo-Visit_SafeSpace_AI-6366f1?style=for-the-badge" />
  </a>
  &nbsp;
...
<table>
  <tr>
    ...
    <td align="center" width="50%">
      <img src="./screenshots/detector-input.png" width="100%" alt="Detector Page"/>
      <br/><br/><b>⚙️ Incident Input — Minimal input canvas with demo selector pills.</b>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="./screenshots/demo-loaded.png" width="100%" alt="Demo Scenario Loaded"/>
      <br/><br/><b>💡 Scenario Selection — Clean text pre-fill and tracking badges.</b>
    </td>
    <td align="center" width="50%">
      <img src="./screenshots/analysis-dashboard.png" width="100%" alt="Analysis Dashboard"/>
      <br/><br/><b>📊 High-density 3-Column Results — Threat classification, severity score, and support chat.</b>
    </td>
  </tr>
  <tr>
    <td align="center" width="100%" colspan="2">
      <img src="./screenshots/safety-report.png" width="100%" alt="Safety Report Output"/>
...
```mermaid
flowchart TD
    A([🛡️ Survivor Enters Text]) --> B[☁️ Client-side State]
    B --> C[🧠 Groq Llama 3.1 8B API]
    C --> D[🔍 Threat Classification\n& Severity Assessment]
    D --> G[📋 Structured Results\n━━━━━━━━━━━━━\n✦ Threat Category\n✦ Severity Score\n✦ Key Indicators\n✦ Risk Triage Badges\n✦ Context Assessment]
    G --> H[(💾 Local Storage Only\nNo Data Retention)]
    G --> I[🖥️ 3-Column React UI]

    style A fill:#1e3a8a,color:#fff,stroke:#1d4ed8
    style B fill:#1e293b,color:#fff,stroke:#475569
    style C fill:#312e81,color:#fff,stroke:#4338ca
    style D fill:#1e1b4b,color:#fff,stroke:#4f46e5
    style G fill:#581c87,color:#fff,stroke:#701a75
    style H fill:#111827,color:#fff,stroke:#1f2937
    style I fill:#064e3b,color:#fff,stroke:#059669
```
...
graph TB
    subgraph CLIENT["🖥️ React 19 Frontend (Vite + Tailwind)"]
        ...
        DT[Threat Classification]
        AI[Support Companion]
        W[Severity Indicator]
        IN[Incident Report Output]
        SC[Safety Resources Panel]
    end

    subgraph API_LAYER["⚙️ Groq SDK Layer"]
        R1[detectThreat]
        R2[assessSeverity]
        R3[chatWithCompanion]
        R4[generateReport]
        R5[routeToResources]
    end

    subgraph EXTERNAL["🌐 AI Models (Groq Cloud)"]
        GV[Llama 3.1 8B - Fast]
        GC[Llama 3.3 70B - Smart]
    end

    subgraph STORAGE["💾 Local Storage (Privacy First)"]
        U[(User Session Data)]
        S[(Local Settings)]
    end

    CLIENT -->|State Management| API_LAYER
    API_LAYER --> EXTERNAL
    CLIENT --> STORAGE

    style CLIENT fill:#090d16,color:#fff,stroke:#4F46E5
    style API_LAYER fill:#090d16,color:#fff,stroke:#10B981
    style EXTERNAL fill:#090d16,color:#fff,stroke:#8B5CF6
    style STORAGE fill:#090d16,color:#fff,stroke:#3B82F6
```
...
![Groq](https://img.shields.io/badge/Groq_Cloud-F26522?style=for-the-badge&logo=google-cloud&logoColor=white)
![Llama](https://img.shields.io/badge/Meta_Llama-044F8C?style=for-the-badge&logo=meta&logoColor=white)
...
&nbsp;&nbsp;
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-SafeSpace_AI-6366f1?style=for-the-badge)](https://safespace-ai-five.vercel.app)
...
![Visitor Count](https://visitor-badge.laobi.icu/badge?page_id=abhishek-ms-01.SafeSpace-AI&style=for-the-badge&color=6366f1)
